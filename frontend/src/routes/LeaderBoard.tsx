  ...
  return (
    <div className="background">
      <div className="leardboard-logo">
        <b>
          A<span>ch</span>i<span>e</span>
          <span>v</span>e<span>me</span>n<span>ts</span>
        </b>
      </div>
      <div className="block" />
      {
...
function BadgeReward({ rank }: { rank: number }) {
  return (
    <div className="badge">
      <div className="top-index">{rank}</div>
      <svg
        width="40"
        height="40"
        viewBox="0 0 512 512"
      ...
      >
        <path
          d="M472.038 443.917L412.343 279.908C429.649 251.901 439.653 218.926 439.653 183.654C439.653 
                    ...
                    361.95C334.149 353.524 364.511 335.559 388.143 311.056L426.872 417.461L377.808 394.58Z"
          fill="white"
        />
      </svg>
    </div>
